...
def loginUser():
    if request.method == "POST":
        ...
        if len(result) == 0:
            ...
            return "<html><body>"+" <ul><li><a href=""AveragePriceResale"">Resale Graph</a></li><li><a href=""Rental"">Rental Graph</a></li><li><a href =""Profile"">Profile</a></li></ul>" + displayResaleData() + displayRentData() + "</html></body>"
        else:
            session["loggedIn"] = False
